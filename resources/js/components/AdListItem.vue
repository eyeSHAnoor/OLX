<template>
    <div
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <!-- Image Container -->
            <div class="md:w-56 h-56 bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden flex-shrink-0">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-start justify-between mb-3">
                            ...
                            <button @click.stop="toggleFavorite"
                                class="ml-4 flex-shrink-0 bg-gray-100 hover:bg-gray-200 p-3 rounded-full transition-colors duration-200"
                        ...
                        <!-- Description -->
                        <p v-if="ad.description" class="text-gray-600 mb-4 line-clamp-2">
                            {{ ad.description }}
                        </p>
                        ...
                        <div class="flex flex-wrap gap-4 mb-4">
                            ...
                            <div v-if="ad.category" class="flex items-center text-gray-600">
                                <svg class="w-4 h-4 mr-1.5 text-gray-400" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            ...
                            <div v-if="ad.brand" class="flex items-center text-gray-600">
                                <svg class="w-4 h-4 mr-1.5 text-gray-400" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
