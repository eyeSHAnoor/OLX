  ...
  <Link :href="route('ads.show', ad.id)" class="block h-full">
    ...
    >
      ...
      <div :class="['flex flex-col flex-grow', size === 'small' ? 'p-2' : 'p-3 sm:p-4']">
        ...
        <div
          v-if="ad.discount && ad.discount > 0"
        ...
        >
          <div class="flex items-center">
            <svg
              :class="size === 'small' ? 'w-3 h-3 mr-0.5' : 'w-3.5 h-3.5 mr-1'"
            ...
            <span
              :class="
                size === 'small' ? 'text-[10px] line-clamp-1' : 'text-xs line-clamp-1'
              "
            >
        ...
        <!-- Footer -->
        <div
          class="flex items-center justify-between pt-1 mt-auto border-t border-gray-100"
        >
