		...
		<div class="flex items-center space-x-6 lg:space-x-8 ml-auto">
			<div class="flex items-center space-x-2">
				...
				<Select :model-value="`${table.getState().pagination.pageSize}`" @update:model-value="table.setPageSize">
					<SelectTrigger class="h-8 min-w-[70px]">
			...
			<div class="flex items-center space-x-2">
				<Button
					...
					<Icon icon="radix-icons:double-arrow-left" class="siz-4" />
				</Button>
				<Button
					variant="outline"
					class="w-8 h-8 p-0"
				...
				<Button
					...
					<Icon icon="radix-icons:double-arrow-right" class="siz-4" />
				</Button>
			</div>
		</div>
	</div>
