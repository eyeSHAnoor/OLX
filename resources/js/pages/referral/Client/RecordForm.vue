    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="flex flex-col sm:flex-row gap-3 mb-6">
            <button @click="router.visit(route('downline-referrals.index'))" :disabled="form.processing"
                class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
            ...
            <button @click="submit" :disabled="form.processing"
                class="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
            ...
            <div class="px-6 py-6 space-y-6">
                ...
                <div v-if="!isEditing">
                    ...
                    <div class="relative">
                        <div class="flex gap-2">
                            <div class="relative flex-1">
                                <input v-model="search" type="email" placeholder="Enter email address..."
                                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors disabled:bg-gray-100 disabled:cursor-not-allowed"
                                    :disabled="!!selectedUserId" />
                                <div v-if="isLoading" class="absolute right-3 top-2.5">
                                    <svg class="w-5 h-5 text-gray-400 animate-spin" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                                    </svg>
                        ...
                        <!-- Success: User found -->
                        <div v-if="searchResult && !selectedUserId"
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex gap-2">
                        ...
                        <button v-if="form.referral_code" type="button"
