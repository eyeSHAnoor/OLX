  ...
  <OlxLayout>
    ...
    <div class="max-w-full px-2 md:max-w-8/10 mx-auto space-y-12 pb-20">
      ...
      <div v-if="!ad" class="flex items-center justify-center min-h-[60vh]">
        <div class="text-center">
          <Icon
            ...
            class="size-6 sm:size-8 animate-spin text-primary mx-auto mb-3"
          />
      ...
      <div v-else class="container mx-auto px-3 sm:px-4 py-4 sm:py-6 max-w-7xl">
        <!-- Breadcrumb - Compact -->
        <nav
          class="flex items-center gap-1.5 text-xs sm:text-sm text-gray-500 mt-3 flex-wrap"
        >
          <button
            @click="goBack"
          ...
          <a
            :href="route('category.show', ad.category.slug)"
          ...
          <Icon icon="lucide:chevron-right" class="size-3 sm:size-3.5 flex-shrink-0" />
          <span
            class="text-gray-700 font-medium truncate max-w-[150px] sm:max-w-[300px]"
            >{{ ad.ad_title }}</span
          >
        </nav>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div class="lg:col-span-2 space-y-4 sm:space-y-5">
            ...
            <div class="bg-white rounded-lg sm:rounded-xl shadow-sm overflow-hidden">
              ...
              <div class="relative aspect-[16/9] bg-gray-100">
                ...
                >
                  <Icon
                    :icon="isFavorited ? 'mdi:heart' : 'lucide:heart'"
                    class="size-4 sm:size-5 transition-colors"
                    :class="[
            ...
            <div class="bg-white rounded-lg sm:rounded-xl shadow-sm p-4 sm:p-5 lg:p-6">
              <div class="flex items-start justify-between gap-3 mb-3 sm:mb-4">
                ...
                <div class="flex items-center gap-2 sm:gap-3">
                  ...
                  <button
                    @click="!hasOrdered && ad?.user?.id !== userId && handleShowModal()"
              ...
              <div
                class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 sm:mb-5"
              >
              ...
              <div class="mb-4 sm:mb-5">
                ...
                <p
                  class="text-xs sm:text-sm text-gray-700 leading-relaxed whitespace-pre-line"
                >
                  {{ ad.description }}
                </p>
              </div>
              ...
              <!-- Search Keywords -->
              <div
                v-if="ad.search_keywords?.length"
                class="border-t pt-4 sm:pt-5 mt-4 sm:mt-5"
              >
                <h2 class="text-base sm:text-md font-semibold mb-2 sm:mb-3">
                  Related Keywords
                </h2>
                <div class="flex flex-wrap gap-1.5 sm:gap-2">
                  <span
                    v-for="keyword in ad.search_keywords.slice(0, 15)"
                    :key="keyword"
                  ...
                  <span
                    v-if="ad.search_keywords.length > 15"
          ...
          <div class="space-y-4 sm:space-y-5">
            ...
            <div class="bg-white rounded-lg sm:rounded-xl shadow-sm p-4 sm:p-5">
              ...
              <Link
                :href="route('user.profile', ad?.user?.id)"
              ...
              >
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-center gap-2 flex-wrap">
                    ...
                    <div
                      v-if="$hasPlanPermission('pro_batch', ad?.user)"
                      class="flex-shrink-0"
                    >
                      <img src="/images/pro.png" alt="Pro" class="h-7 w-auto" />
                    </div>
                    <div
                      v-if="$hasPlanPermission('premium_batch', ad?.user)"
                      class="flex-shrink-0"
                    >
            ...
            <div class="bg-blue-50 rounded-lg sm:rounded-xl p-4 sm:p-5">
              <h3
                class="font-semibold flex items-center gap-1.5 mb-2 text-sm sm:text-base"
              >
        ...
        <div class="bg-white rounded-lg sm:rounded-xl shadow-sm p-4 sm:p-5 lg:p-6 mt-6">
          ...
          <div class="mb-6">
            ...
            <div
              v-if="page.props.auth?.user && page.props.auth.user.id !== ad?.user_id"
            ...
            >
              <p class="text-sm text-gray-600">
                <Link href="/login" class="text-primary font-medium hover:underline"
                  >Sign in</Link
                >
            ...
            <div
              v-else-if="page.props.auth?.user && page.props.auth.user.id === ad?.user_id"
              class="bg-gray-50 rounded-lg p-4 text-center"
            >
              <p class="text-sm text-gray-600">
          ...
          <div v-if="recentRatings.length > 0">
            <div class="flex items-center justify-between mb-3">
              ...
              <Link
                v-if="adRatingCount > 3"
                :href="route('ad.ratings', ad?.id)"
              ...
              >
                <div class="flex-1">
                  <div class="flex items-center gap-2 mb-1">
                    <Link
                      :href="route('user.profile', rating.rater?.id)"
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          <button
            @click="zoomOut"
            class="text-white text-2xl font-bold px-2 touch-manipulation"
          >
            −
          </button>
        ...
        >
          <img
            :src="`/storage/${ad.images[lightboxIndex]?.path}`"
            :alt="ad.ad_title"
