      ...
      <div class="bg-white rounded-lg border border-gray-200 overflow-hidden mb-6">
        ...
        <div class="px-2 sm:px-5 pb-5 relative">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            ...
            <!-- Location -->
            <div v-if="profileUser.profile?.location" class="flex items-center gap-3 p-2.5 bg-gray-50 rounded-lg">
              <div class="flex-shrink-0">
                <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <!-- Website -->
            <div v-if="profileUser.profile?.website" class="flex items-center gap-3 p-2.5 bg-gray-50 rounded-lg">
              <div class="flex-shrink-0">
                <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="space-y-3">
          ...
          <div class="mb-4 p-3 bg-gray-50 rounded-lg">
            <div class="flex items-center justify-between mb-2">
              ...
              <span class="text-xs text-gray-500">{{ totalRatings }} {{ totalRatings === 1 ? "rating" : "ratings"
                }}</span>
            </div>
