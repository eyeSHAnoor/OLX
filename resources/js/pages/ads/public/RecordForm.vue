...
<template>
    <OlxLayout>
        <AppContainer class="max-w-8/10 mx-auto  space-y-12 py-10">
                ...
                <div class="lg:col-span-2">
                    <Card>
                        ...
                        <CardContent class="space-y-6">
                            ...
                            <!-- Seller Information -->
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <TextInput label="Seller Name *" v-model="form.seller_name"
                                    :error="form.errors.seller_name" placeholder="Enter seller name" required />
                        ...
                        <CardContent class="space-y-4">
                            <div class="flex flex-col gap-2">
                                <AppButton :label="ad ? 'Update Ad' : 'Publish Ad'" icon="lucide:check"
                                    ...
                                    class="bg-brand-teal hover:bg-brand-teal/80 w-full justify-center" />
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div v-if="form.search_keywords.length > 0" class="pt-2">
                                        <div class="flex flex-wrap gap-1">
                                            <span v-for="(keyword, index) in form.search_keywords.slice(0, 3)"
                                                :key="index"
